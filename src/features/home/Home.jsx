...
export default function Home() {
  ...
  return (
    <div className="pt-16"> {/* important because navbar is fixed */}
          ...
          {featuredProducts.map((product) => (
            <div key={product._id} className="text-center">
              ...
              <img
                ...
                alt={product.title}
                className="h-75 md:h-100 object-contain mx-auto hover:scale-105 transition duration-300"
              />
      ...
      {/* ================= TOP PICKS ================= */}
      <section className="w-full bg-amber-50 py-20 flex justify-center">
        <div className="max-w-360 w-full px-6 md:px-12 lg:px-24 text-center">

          <h2 className="text-4xl text-black font-medium font-['Poppins']">
            Top Picks For You
          </h2>
            ...
            {topProducts.map((product) => (
              <div key={product._id} className="text-center">
                ...
                <img
                  src={getImage(product)}
                  alt={product.title}
                  className="h-50 md:h-55 object-contain mx-auto hover:scale-105 transition duration-300"
                />

                <h3 className="mt-6 text-black text-base font-normal font-['Poppins']">
                  {product.title}
                </h3>
      ...
      {/* ================= NEW ARRIVAL ================= */}
      <section className="w-full bg-amber-100 py-20 flex justify-center">
        <div className="max-w-360 w-full px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-black text-5xl font-bold font-['Poppins'] mt-4">
              Asgaard sofa
            </h2>
            ...
            {blogProducts.map((product) => (
              <div key={product._id} className="text-center">
                ...
                <img
                  src={getImage(product)}
                  alt={product.title}
                  className="rounded-xl h-62.5 md:h-75 w-full object-cover"
                />
                ...
                <div className="flex justify-center gap-6 mt-3 text-gray-500 text-sm">
                  ...
                  <span>🕒 {new Date(product.createdAt).toLocaleTimeString([], {
                    hour: "2-digit",
                    minute: "2-digit",
                  })}</span>
                </div>
      ...
      <section
        ...
        style={{ backgroundImage: `url('/image/instagram.jpg')` }}
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-80 md:h-96 text-center px-6">
          <h2 className="text-black text-6xl font-bold font-['Poppins']">
            Our Instagram
          </h2>

          <p className="mt-6 text-black text-xl font-normal font-['Poppins']">
